...
class SlashPerms:
    def memplus_and_up(self) -> List[CommandPermission]:
        return permissions.calculate_permissions(1)

    def mempro_and_up(self) -> List[CommandPermission]:
        return permissions.calculate_permissions(2)

    def memed_and_up(self) -> List[CommandPermission]:
        return permissions.calculate_permissions(3)

    def genius_and_up(self) -> List[CommandPermission]:
    ...
    def submod_or_admin_and_up(self) -> List[CommandPermission]:
        return permissions.calculate_permissions(6) + [CommandPermission(id=guild_service.get_guild().role_sub_mod, type=1, permission=True)]

    def genius_or_submod_and_up(self) -> List[CommandPermission]:
        return permissions.calculate_permissions(4) + [CommandPermission(id=guild_service.get_guild().role_sub_mod, type=1, permission=True)]
